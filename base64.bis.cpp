...
int  __attribute__((weak)) base64_decode_bis(size_t in_len, const char *in, size_t out_len, unsigned char *out) {
	unsigned int ii, io;
	uint32_t v;
	unsigned int rem;
...
int __attribute__((weak)) base64_encode_bis(size_t in_len, const unsigned char *in, size_t out_len, char *out) {
	unsigned ii, io;
	uint32_t v;
	unsigned rem;
